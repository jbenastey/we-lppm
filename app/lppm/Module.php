...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerServices(DiInterface $di)
    {
        ...
        $di->set('dispatcher', function () {
            ...
            $dispatcher->setDefaultNamespace('LPPMKP\Lppm\Controllers\\');
            return $dispatcher;
        });
        ...
        $di->set('view', function () {
            $view = new View();
            $view->setViewsDir($this->getConfig()->application->lppmViewsDir);
        ...
        $di->set('db', function () {
            ...
            $params = [
                ...
                'dbname' => $config->database->dbnameLppm,
